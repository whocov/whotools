#' function to apply a moving average to a numeric column. Use this function within `mutate()`
#' Note that function requires data to be sorted by date. By default calculates a 7 day moving average.
#'
